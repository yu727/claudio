...
- Codex AI for music planning, Fish Audio for TTS, Netease Cloud Music for songs
...
- apps/server/src/services/ — business logic (ncm, Codex, tts, weather, etc.)
...
## Current Features
- AI-powered music planning (Codex generates playlists based on context)
